...
category1_Id VARCHAR(20) NOT NULL,
category2_Id VARCHAR(20) NULL DEFAULT NULL,
category3_Id VARCHAR(20) NULL DEFAULT NULL,
servings_Number  INT NOT NULL,
PRIMARY KEY (recipe_Id),
CONSTRAINT tbl_recipe_ibfk_1
  FOREIGN KEY (category1_Id)
  REFERENCES tbl_category(category_Id),
CONSTRAINT tbl_recipe_ibfk_2
  FOREIGN KEY (category2_Id)
  REFERENCES Tbl_category(category_Id),
CONSTRAINT tbl_recipe_ibfk_3
